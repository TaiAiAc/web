...
import { cleanup, generateRoute, gitCommit, gitCommitVerify, release, updatePkg } from './commands'
import { loadCliOptions } from './config'

type Command = 'cleanup' | 'update-pkg' | 'git-commit' | 'git-commit-verify' | 'release' | 'gen-route'
